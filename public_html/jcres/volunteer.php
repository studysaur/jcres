...
$q = "SELECT uid, l_name, f_name, unit_num FROM ".TBL_USERS." WHERE status & 2 OR status & 16 ORDER BY l_name"; // the where gets rid of officers marked as inactive
$result = $database->query($q);
