...
$admin = $status & 0x8000; 
if($admin)	{
$q = "SELECT DISTINCT user.f_name, user.l_name, user.username, user.uid FROM user INNER JOIN credits  ON credits.uid = user.uid WHERE credits.date > '2021-12-06' ORDER BY user.l_name"; 
...
"$option"?></td></tr>
	...
	echo "<h2>This reflects credits earned in 2021, but paid in 2022</h1><br>";
...
if ($datePosted < '2021-12-01' )  {
		}
	else if($datePosted < '2021-12-01') {
