...
/*        else if($retval == 2){
   ...
   function procAdminEditUser(){
      ...
      $retval = $session->AdminEditUser($_POST['user'], $_POST['userlevel'], $_POST['unit_num'], $_POST['rank'], $_POST['name'], $_POST['phone_home'], $_POST['phone_work'], $_POST['phone_cell'],$_POST['email'], $_POST['probation']);
...
$_POST['num_officers'], $_POST['officer_1'], $_POST['officer_2'], $_POST['officer_3'], 
$_POST['officer_4'], $_POST['officer_5'], $_POST['officer_6'], $_POST['officer_7'], 
$_POST['officer_8'],$paid_detail,$detail_num);
