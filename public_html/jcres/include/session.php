...
class Session
{
   ...
   var $uid;       //Random value generated on current login
//   var $userlevel;    //The level to which the user pertains
   ...
   function checkLogin(){
      ...
      if(isset($_SESSION['username']) && isset($_SESSION['password'])) {
         ...
         if($database->confirmUserID($_SESSION['username'], $_SESSION['password'])) {
...
//      $this->userlevel = $this->userinfo['userlevel'];
 ...
 //     $database->updateUserField($this->username, "userid", $this->userid);
      $database->addActiveUser($this->username, $this->time, $this->uid);
...
/**
    ...
    */
   function AdminEditUser($subuser, $subfname, $submname, $sublname, $subunit_num, $subrank, $subcode, $subsquad, $subphone_home, $subphone_work, $subphone_cell, $subuid){
      global $database, $form, $mailer;  //The database, form and mailer object
      ...
      /* No errors, update the account  */
     	  ...
     	  if($database->updateUserAccountByAdmin($subuser, $subfname, $submname, $sublname, $subunit_num, $subrank, $subcode, $subsquad, $subphone_home, $subphone_work, $subphone_cell, $subuid)){
            return 0;  //New user added succesfully
         }else{
    ...
    */
    function isadmin() {
      return ($this->status & 0x8000 == 0x8000);
   }
