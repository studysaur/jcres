...
<title>Citation Report</title></head>
...
<?php	print("<li><a href=\"userinfo.php?user=$session->username\">My 
Account</a></li>");	?>
...
if (isset($_SESSION['status'])){
	...
	$admin = (($status	& 0x800) == 0x800) ? true : false;
	$edit = (($status	& 0x400) == 0x400) ? true : false;
	$post = (($status	& 0x800) == 0x800) ? true : false;
} else {
...
if($admin || $edit  || $post):?>
	...
	<tr>
		<td align="right"><a href="money_owed_form.php">Amounts Owed to Deputies - Detailed Listing</a></td>
	</tr>
	<tr>
