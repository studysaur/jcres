...
<title>Jackson County Mounted Patrol - Gallery</title>
<style type="text/css"> 
<!-- 
   ...
   <div id="sidebar1">
  	<div id="listnav">
  		<ul>
  			...
  			<li><a href="aboutus.php">Meet the Members</a></li>
  			<li><a href="gallery.php">Photo Gallery</a></li>
  			<li><a href="main.php">Member Login</a></li>
  			<li><a href="application.php">How to Apply</a></li>
    ...
    <!-- end #sidebar1 --></div>
  <div id="mainContent">
    <h1> The Gallery page is under construction.</h1>
    <p>&nbsp;</p>
    <!-- end #mainContent --></div>
