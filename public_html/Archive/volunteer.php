...
$q = "SELECT * FROM ".TBL_DETAILS." WHERE detail_num = '$detail_num'";
...
<tr><th><h2>Officer</h2></th><th><h2>Hours</h2></th><th><h2>Amount Made</h2></th><th width="250"><h2>Remarks</h2></th></tr>
<?
$z = "1";
foreach ($officer as $value)	{
	if($value)	{
	print("<tr><td><input type=\"text\" name=\"officer$z\" value=\"$value\"></td><td><input type=\"text\" name=\"hours$z\" ></td><td><input type=\"text\" name=\"dollars$z\"></td><td><input type=\"text\" name=\"remarks$z\"</td></tr>");
	$z++;
		}
	}
...
$q = "SELECT name FROM ".TBL_USERS." ORDER BY name";
$result = $database->query($q);
...
<tr>
	<td>Date:</td>
	<td><input type="text" name="date" maxlength="12" value="<? 
			if ($form->value("date") == "")		{
				echo "$date";	}
			else	{
...
<tr>
	<td>Detail Type:</td>
	<td><input type="text" name="detail_type" maxlength="80" value="<? 
			if ($form->value("detail_type") == ""){
				echo "$detail_type";	}
			else	{
				echo $form->value("detail_type");  }?>"></td>
	<td><? echo $form->error("detail_type"); ?></td>
</tr>
<tr>
	<td>Detail Location:</td>
	<td><input type="text" name="detail_location" maxlength="50" value="<? 
			if ($form->value("detail_location") == ""){
				echo "$detail_location";	}
			else	{
				echo $form->value("detail_location");  }?>"></td>
	<td><? echo $form->error("detail_location");?></td>
</tr>
<tr>
	<td>Start Time:</td>
<?
...
<tr>
	...
	<td><input type="text" name="contact" maxlength="40" value="<? 
			if ($form->value("contact") == ""){
				echo "$contact";	}
			else	{
				echo $form->value("contact"); }?>"></td>
	<td> <? echo $form->error("contact");?></td>
</tr>
<tr>
	<td>Number Officers Needed:</td>
	<td><input type="text" name="num_officers" maxlength="4" value="<? 
			if ($form->value("num_officers") == ""){
				echo "$num_officers";	}
			else	{
				echo $form->value("num_officers");  }?>"></td>
	<td><? echo $form->error("num_officers");?></td>
</tr>
<tr>
	<td>Officer 1:</td>
...
<tr>
	<td colspan="2" align="right">
			<input type="hidden" name="subeditdetail" value="<?echo "$detail_num"?>">
...
$q = "SELECT date,detail_location FROM ".TBL_DETAILS." WHERE detail_num = 
'$detail'";
 $result = $database->query($q);
...
<tr><td><h3><?echo "$location";?> on <?echo "$date.";?></h3></td></tr>
...
<tr><td><input type="hidden" name="subdeletedetail" value="<?echo "$detail"?>">
...
$q = "SELECT * FROM ".TBL_DETAILS." WHERE detail_num ='$detail'";
$result = $database->query($q);
...
|| $officer7 == $user || $officer8 == $user || $officer9 == $user || $officer10 == $user )	{
		...
		?><img src="images/fool1.jpg" width="480px" hspace="200"><?
	}

	else	if($field == "")	{
			$q = "UPDATE ".TBL_DETAILS." SET $officer_num = '$user' WHERE detail_num = '$detail'";
