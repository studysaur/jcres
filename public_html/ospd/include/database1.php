...
$officer_3, $officer_4, $officer_5, $officer_6, $officer_7, $officer_8, $officer_9,
 $officer_10, $paid_detail)	{
   ...
   $q = "INSERT INTO ".TBL_DETAILS." VALUES ('NULL', '$date', '$detail_type', 
'$detail_location', '$start_time', '$end_time', '$contact', 
'$num_officers', '$officer_1', '$officer_2', '$officer_3', '$officer_4', 
'$officer_5', '$officer_6', '$officer_7', '$officer_8', '$officer_9', '$officer_10', '0', 
'$paid_detail')";
...
start_time='$start_time', end_time='$end_time', contact='$contact', 
...
paid_detail='$paid_detail' WHERE detail_num = '$detail_num'";
